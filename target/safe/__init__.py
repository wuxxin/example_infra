...
from infra.fcos import ButaneTranspiler, FcosConfigUpdate, LibvirtIgniteFcos, TangFingerprint
...
# update host to newest config, should be a no-op (0 changed) on machine creation
host_update = FcosConfigUpdate(
    shortname, target, host_config, opts=pulumi.ResourceOptions(depends_on=[host_machine])
)
